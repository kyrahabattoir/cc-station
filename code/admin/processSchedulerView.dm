...
/datum/processSchedulerView/proc/bootstrap_browse()
	/*
	usr << browse('browserassets/js/bootstrap.min.js', "file=bootstrap.min.js;display=0")
	usr << browse('browserassets/css/bootstrap.min.css', "file=bootstrap.min.css;display=0")
	usr << browse('browserassets/images/glyphicons-halflings-white.png', "file=glyphicons-halflings-white.png;display=0")
	usr << browse('browserassets/images/glyphicons-halflings.png', "file=glyphicons-halflings.png;display=0")
	usr << browse('browserassets/js/json2.min.js', "file=json2.js;display=0")
	*/
