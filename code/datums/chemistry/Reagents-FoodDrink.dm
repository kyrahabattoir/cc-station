...
/datum/reagent/fooddrink
			name = "food drink stuff"
			reagent_state = REAGENT_SOLID


/datum/reagent/fooddrink/bilk
	name = "bilk"
	id = "bilk"
	fluid_r = 147
	fluid_g = 100
...
/datum/reagent/fooddrink/bilk/on_mob_life(var/mob/M) //temp
	if(!M)
		M = holder.my_atom
	if(M.losebreath > 10)
...
/datum/reagent/fooddrink/milk/on_mob_life(var/mob/M)
	if (!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/milk/chocolate_milk
	name = "chocolate milk"
	id = "chocolate_milk"
	fluid_r = 133
	fluid_g = 67
...
/datum/reagent/fooddrink/milk/strawberry_milk
...
/datum/reagent/fooddrink/alcoholic
...
/datum/reagent/fooddrink/alcoholic/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/alcoholic/beer/reaction_temperature(exposed_temperature, exposed_volume)
...
/datum/reagent/fooddrink/alcoholic/beer/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
...
/datum/reagent/fooddrink/alcoholic/boorbon
	name = "BOOrbon"
	id = "boorbon"
	fluid_r = 121
	fluid_g = 171
...
/datum/reagent/fooddrink/alcoholic/beepskybeer
...
/datum/reagent/fooddrink/alcoholic/beepskybeer/on_mob_life(var/mob/living/M)
	if (!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/alcoholic/moonshine/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/alcoholic/bojack // Bar Contest Winner's Drink
...
/datum/reagent/fooddrink/alcoholic/bojack/on_mob_life(var/mob/target)
	if(!target)
		target = holder.my_atom
...
/datum/reagent/fooddrink/alcoholic/bojack/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(method != REAC_INGEST)
...
/datum/reagent/fooddrink/alcoholic/cocktail_screwdriver
	name = "Screwdriver"
	id = "screwdriver"
...
/datum/reagent/fooddrink/alcoholic/cocktail_bloodymary
	name = "Bloody Mary"
	id = "bloody_mary"
...
/datum/reagent/fooddrink/alcoholic/cocktail_bloodyscary
	name = "Bloody Scary"
	id = "bloody_scary"
...
/datum/reagent/fooddrink/alcoholic/cocktail_suicider
	name = "Suicider"
	id = "suicider"
...
/datum/reagent/fooddrink/alcoholic/cocktail_grog/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	if (prob(15))
		M.take_toxin_damage(1)
...
/datum/reagent/fooddrink/alcoholic/cocktail_grog/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/alcoholic/cocktail_grog/reaction_obj(var/obj/O, var/volume)
...
/datum/reagent/fooddrink/alcoholic/port
	name = "port"
	id = "port"
...
/datum/reagent/fooddrink/alcoholic/port/on_mob_life(var/mob/M)
...
/datum/reagent/fooddrink/alcoholic/bitters/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/alcoholic/whiskey_sour
	name = "Whiskey Sour"
	id = "whiskey_sour"
	fluid_r = 170
	fluid_g = 188
...
/datum/reagent/fooddrink/alcoholic/daiquiri
	name = "Daiquiri"
	id = "daiquiri"
	fluid_r = 8
	fluid_g = 65
...
/datum/reagent/fooddrink/alcoholic/martini
	name = "Martini"
	id = "martini"
	fluid_r = 238
	fluid_g = 238
...
/datum/reagent/fooddrink/alcoholic/v_martini
	name = "Vodka Martini"
	id = "v_martini"
	fluid_r = 238
	fluid_g = 238
...
/datum/reagent/fooddrink/alcoholic/Manhattan
	name = "Manhattan"
	id = "manhattan"
	fluid_r = 164
	fluid_g = 84
...
/datum/reagent/fooddrink/alcoholic/libre
...
/datum/reagent/fooddrink/alcoholic/ginfizz
	name = "Gin Fizz"
	id = "ginfizz"
	fluid_r = 248
	fluid_g = 255
...
/datum/reagent/fooddrink/alcoholic/gimlet
	name = "Gimlet"
	id = "gimlet"
	fluid_r = 222
	fluid_g = 255
...
/datum/reagent/fooddrink/alcoholic/v_gimlet
	name = "Vodka Gimlet"
	id = "v_gimlet"
	fluid_r = 222
	fluid_g = 255
...
/datum/reagent/fooddrink/alcoholic/w_russian
	name = "White Russian"
	id = "w_russian"
	fluid_r = 244
	fluid_g = 244
...
/datum/reagent/fooddrink/alcoholic/b_russian
	name = "Black Russian"
	id = "b_russian"
	fluid_r = 99
	fluid_g = 32
...
/datum/reagent/fooddrink/alcoholic/irishcoffee
	name = "Irish Coffee"
	id = "irishcoffee"
	fluid_r = 54
	fluid_g = 42
...
/datum/reagent/fooddrink/alcoholic/cosmo
	name = "Cosmopolitan"
	id = "cosmo"
	fluid_r = 250
	fluid_g = 206
...
/datum/reagent/fooddrink/alcoholic/beach
...
/datum/reagent/fooddrink/alcoholic/gtonic
	name = "Gin and Tonic"
	id = "gtonic"
	fluid_r = 200
	fluid_g = 200
...
/datum/reagent/fooddrink/alcoholic/vtonic
	name = "Vodka Tonic"
	id = "vtonic"
	fluid_r = 200
	fluid_g = 200
...
/datum/reagent/fooddrink/alcoholic/sonic
	name = "Gin and Sonic"
	id = "sonic"
	fluid_r = 0
	fluid_g = 0
...
/datum/reagent/fooddrink/alcoholic/sonic/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.make_jittery(2)
...
/datum/reagent/fooddrink/alcoholic/gpink
...
/datum/reagent/fooddrink/alcoholic/eraser
	name = "Mind Eraser"
	id = "eraser"
	fluid_r = 90
	fluid_g = 61
...
/datum/reagent/fooddrink/alcoholic/dbreath/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	src = null
...
/datum/reagent/fooddrink/alcoholic/dbreath/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/alcoholic/squeeze
	name = "squeeze"
	id = "squeeze"
...
/datum/reagent/fooddrink/alcoholic/squeeze/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/alcoholic/squeeze/on_mob_life(var/mob/M)
...
/datum/reagent/fooddrink/alcoholic/hunchback
	name = "Hunchback"
	id = "hunchback"
	fluid_r = 50
	fluid_g = 0
...
/datum/reagent/fooddrink/alcoholic/hunchback/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/alcoholic/madmen
	name = "Old Fashioned"
	id = "madmen"
	fluid_r = 240
	fluid_g = 185
...
/datum/reagent/fooddrink/alcoholic/planter
...
/datum/reagent/fooddrink/alcoholic/maitai
	name = "Mai Tai"
	id = "maitai"
	fluid_r = 231
	fluid_g = 107
...
/datum/reagent/fooddrink/alcoholic/harlow
	name = "Jean Harlow"
	id = "harlow"
	fluid_r = 233
	fluid_g = 97
...
/datum/reagent/fooddrink/alcoholic/gchronic
...
/datum/reagent/fooddrink/alcoholic/gchronic/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	if(prob(10))
...
/datum/reagent/fooddrink/alcoholic/margarita
	name = "Margarita"
	id = "margarita"
	fluid_r = 183
	fluid_g = 242
...
/datum/reagent/fooddrink/alcoholic/tequini
	name = "Tequini"
	id = "tequini"
	fluid_r = 251
	fluid_g = 255
...
/datum/reagent/fooddrink/alcoholic/pfire
	name = "Prairie Fire"
	id = "pfire"
	fluid_r = 184
	fluid_g = 44
...
/datum/reagent/fooddrink/alcoholic/pfire/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	if(prob(20))
...
/datum/reagent/fooddrink/alcoholic/bull
	name = "Brave Bull"
	id = "bull"
	fluid_r = 60
	fluid_g = 42
...
/datum/reagent/fooddrink/alcoholic/longisland
...
/datum/reagent/fooddrink/alcoholic/longbeach
...
/datum/reagent/fooddrink/alcoholic/pinacolada
	name = "Piña Colada"
	id = "pinacolada"
	fluid_r = 255
	fluid_g = 255
...
/datum/reagent/fooddrink/alcoholic/mimosa
	name = "Mimosa"
	id = "mimosa"
	fluid_r = 240
	fluid_g = 184
...
/datum/reagent/fooddrink/alcoholic/french75
	name = "French 75"
	id = "french75"
	fluid_r = 194
	fluid_g = 147
...
/datum/reagent/fooddrink/alcoholic/negroni
	name = "Negroni"
	id = "negroni"
	fluid_r = 167
	fluid_g = 0
...
/datum/reagent/fooddrink/alcoholic/necroni
	name = "Necroni"
	id = "necroni"
	fluid_r = 152
	fluid_g = 171
...
/datum/reagent/fooddrink/ectocooler
	name = "Ecto Cooler"
	id = "ectocooler"
	fluid_r = 105
	fluid_g =  255
...
/datum/reagent/fooddrink/ectocooler/on_mob_life(var/mob/M)
	if(!M) M = holder.my_atom
...
/datum/reagent/fooddrink/refried_beans
	name = "refried beans"
	id = "refried_beans"
...
/datum/reagent/fooddrink/refried_beans/on_mob_life(var/mob/M)
	if(!M) M = holder.my_atom
	M.nutrition++
...
/datum/reagent/fooddrink/death_spice
	name = "death spice"
	id = "death_spice"
...
/datum/reagent/fooddrink/death_spice/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/bread/reaction_turf(var/turf/T, var/volume)
	src = null
...
/datum/reagent/fooddrink/george_melonium
...
/datum/reagent/fooddrink/george_melonium/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/capsaicin
	name = "capsaicin"
	id = "capsaicin"
...
/datum/reagent/fooddrink/capsaicin/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/capsaicin/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/el_diablo
...
/datum/reagent/fooddrink/el_diablo/on_mob_life(var/mob/M)
	..(M)
	if(!M)
		M = holder.my_atom
	M.stuttering += rand(0,5)
...
/datum/reagent/fooddrink/el_diablo/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/space_cola
	name = "cola"
	id = "cola"
...
/datum/reagent/fooddrink/space_cola/on_mob_life(var/mob/M)
	if (ishuman(M))
		var/mob/living/carbon/human/H = M
		if (H.sims)
...
/datum/reagent/fooddrink/cheese
	name = "cheese"
	id = "cheese"
...
/datum/reagent/fooddrink/cheese/reaction_turf(var/turf/T, var/volume)
	src = null
...
/datum/reagent/fooddrink/cheese/on_mob_life(var/mob/M)
	if(prob(3))
		M.reagents.add_reagent("cholesterol", rand(1,2))
	return


/datum/reagent/fooddrink/gcheese
	name = "weird cheese"
	id = "gcheese"
...
/datum/reagent/fooddrink/gcheese/reaction_turf(var/turf/T, var/volume)
	src = null
...
/datum/reagent/fooddrink/gcheese/on_mob_life(var/mob/M)
	if(prob(5))
		M.reagents.add_reagent("cholesterol", rand(1,3))
	return


/datum/reagent/fooddrink/meat_slurry
	name = "meat slurry"
	id = "meat_slurry"
...
/datum/reagent/fooddrink/meat_slurry/reaction_turf(var/turf/T, var/volume)
	src = null
	if(volume >= 5 && prob(10))
...
/datum/reagent/fooddrink/meat_slurry/on_mob_life(var/mob/M)
	..(M) // call your parents  :(
	if(prob(4))
		M.reagents.add_reagent("cholesterol", rand(1,3))
	return
...
/datum/reagent/fooddrink/coffee
	name = "coffee"
	id = "coffee"
...
/datum/reagent/fooddrink/coffee/pooled()
	..()
	remove_buff = 0

/datum/reagent/fooddrink/coffee/on_add()
...
/datum/reagent/fooddrink/coffee/on_remove()
	if(remove_buff)
...
/datum/reagent/fooddrink/coffee/on_mob_life(var/mob/M)
	..(M)
	if (ishuman(M))
		var/mob/living/carbon/human/H = M
		if (H.sims)
...
/datum/reagent/fooddrink/coffee/energydrink
	name = "energy drink"
	id = "energydrink"
...
/datum/reagent/fooddrink/coffee/energydrink/pooled()
	..()
	tickcounter = 0
	return

/datum/reagent/fooddrink/coffee/energydrink/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	if (ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/coffee/energydrink/do_overdose(var/severity, var/mob/M)
...
/datum/reagent/fooddrink/tea/reaction_temperature(exposed_temperature, exposed_volume) //Just an example.
	if (exposed_temperature <= T0C + 7)
		name = "iced tea"
...
/datum/reagent/fooddrink/tea/on_mob_life(var/mob/M)
...
/datum/reagent/fooddrink/honey_tea
	name = "tea"
	id = "honey_tea"
...
/datum/reagent/fooddrink/honey_tea/on_mob_life(var/mob/living/M)
	if (!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/chocolate
	name = "chocolate"
	id = "chocolate"
...
/datum/reagent/fooddrink/chocolate/on_mob_life(var/mob/M)
	M.bodytemperature = min(M.base_body_temp, M.bodytemperature+5)
	M.reagents.add_reagent("sugar", 0.8)
	..(M)
	return

/datum/reagent/fooddrink/chocolate/reaction_turf(var/turf/T, var/volume)
	src = null
	if(volume >= 3)
...
/datum/reagent/fooddrink/nectar
	name = "nectar"
	id = "nectar"
...
/datum/reagent/fooddrink/honey/on_mob_life(var/mob/M)
	M.reagents.add_reagent("sugar",0.4)
	..(M)
	return

/datum/reagent/fooddrink/honey/reaction_turf(var/turf/T, var/volume)
	src = null
	if (volume >= 5)
...
/datum/reagent/fooddrink/royal_jelly
	name = "royal jelly"
	id = "royal_jelly"
...
/datum/reagent/fooddrink/eggnog
	name = "egg nog"
	id = "eggnog"
...
/datum/reagent/fooddrink/eggnog/on_mob_life(var/mob/M)
...
/datum/reagent/fooddrink/guacamole
	name = "guacamole"
	id = "guacamole"
...
/datum/reagent/fooddrink/catonium
	name = "catonium"
	id = "catonium"
	description = "An herbal extract noted for its peculiar effect on felines."
	reagent_state = REAGENT_LIQUID

/datum/reagent/fooddrink/catonium/reaction_obj(var/obj/O, var/volume)
...
/datum/reagent/fooddrink/vanilla
	name = "vanilla"
	id = "vanilla"
...
/datum/reagent/fooddrink/vanilla/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	src = null
...
/datum/reagent/fooddrink/chickensoup
	name = "chicken soup"
	id = "chickensoup"
...
/datum/reagent/fooddrink/chickensoup/on_mob_life(var/mob/living/M)
	if(!M)
		M = holder.my_atom
	for(var/datum/ailment_data/disease/virus in M.ailments)
...
/datum/reagent/fooddrink/salt/reaction_turf(var/turf/T, var/volume)
	src = null
	if (volume >= 10)
		if (!locate(/obj/decal/cleanable/saltpile) in T)
			new /obj/decal/cleanable/saltpile(T)

/datum/reagent/fooddrink/salt/do_overdose(var/severity, var/mob/M)
	if(!M) M = holder.my_atom
	if(!istype(M))
		return
	if(prob(70))
...
/datum/reagent/fooddrink/pepper
	name = "pepper"
	id = "pepper"
...
/datum/reagent/fooddrink/ketchup
	name = "ketchup"
	id = "ketchup"
...
/datum/reagent/fooddrink/mustard
	name = "mustard"
	id = "mustard"
	description = "A condiment often used on hotdogs and sandwiches."
	fluid_r = 255
...
/datum/reagent/fooddrink/porktonium
	name = "porktonium"
	id = "porktonium"
...
/datum/reagent/fooddrink/porktonium/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/mugwort
	name = "mugwort"
	id = "mugwort"
...
/datum/reagent/fooddrink/mugwort/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
...
/datum/reagent/fooddrink/grease
...
/datum/reagent/fooddrink/grease/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.nutrition++
	if(prob(10))
...
/datum/reagent/fooddrink/badgrease
...
/datum/reagent/fooddrink/badgrease/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.nutrition++
	if(prob(15))
...
/datum/reagent/fooddrink/cornstarch
	name = "corn starch"
	id = "cornstarch"
...
/datum/reagent/fooddrink/cornsyrup
	name = "corn syrup"
	id = "cornsyrup"
...
/datum/reagent/fooddrink/cornsyrup/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/VHFCS/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/mashedpotatoes
...
/datum/reagent/fooddrink/msg/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/msg/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/egg/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.nutrition++
...
/datum/reagent/fooddrink/beff/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	if(prob(5))
		M.reagents.add_reagent("cholesterol", rand(1,3))
...
/datum/reagent/fooddrink/enriched_msg //Hukhukhuk brings you another culinary war crime
	name = "Enriched MSG"
	id = "enriched_msg"
...
/datum/reagent/fooddrink/enriched_msg/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/enriched_msg/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/enriched_msg/do_overdose(var/severity, var/mob/M)
...
/datum/reagent/fooddrink/pepperoni //Hukhukhuk presents. pepperoni and acetone
	name = "pepperoni"
	id = "pepperoni"
...
/datum/reagent/fooddrink/pepperoni/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	if(method != REAC_TOUCH)
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/juice_lime
	name = "lime juice"
	id = "juice_lime"
	fluid_r = 33
	fluid_g = 248
...
/datum/reagent/fooddrink/juice_lime/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	if(method != REAC_TOUCH)
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/juice_cran
...
/datum/reagent/fooddrink/juice_orange
	name = "orange juice"
	id = "juice_orange"
	fluid_r = 252
	fluid_g = 163
...
/datum/reagent/fooddrink/juice_orange/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	if(method != REAC_TOUCH)
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/juice_lemon
	name = "lemon juice"
	id = "juice_lemon"
	fluid_r = 251
	fluid_g = 229
...
/datum/reagent/fooddrink/juice_lemon/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	if(method != REAC_TOUCH)
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/juice_tomato
	name = "tomato juice"
	id = "juice_tomato"
	fluid_r = 255
	fluid_g = 0
...
/datum/reagent/fooddrink/juice_strawberry
...
/datum/reagent/fooddrink/juice_cherry
	name = "cherry juice"
	id = "juice_cherry"
	fluid_r = 235
	fluid_g = 0
...
/datum/reagent/fooddrink/juice_pinapple
...
/datum/reagent/fooddrink/coconut_milk
	name = "coconut milk"
	id = "coconut_milk"
	fluid_r = 255
	fluid_g = 255
...
/datum/reagent/fooddrink/juice_pickle
	name = "pickle juice"
	id = "juice_pickle"
	fluid_r = 10
	fluid_g = 235
...
/datum/reagent/fooddrink/cocktail_citrus
	name = "triple citrus"
	id = "cocktail_citrus"
...
/datum/reagent/fooddrink/cocktail_citrus/reaction_mob(var/mob/M, var/method=REAC_INGEST, var/volume)
	if(method != REAC_INGEST)
		return
	if (M.get_toxin_damage())
...
/datum/reagent/fooddrink/lemonade
	name = "lemonade"
	id = "lemonade"
	fluid_r = 237
	fluid_g = 218
...
/datum/reagent/fooddrink/lemonade/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume)
	if(method == REAC_TOUCH)
		if(ishuman(M))
			var/mob/living/carbon/human/H = M
...
/datum/reagent/fooddrink/halfandhalf
	name = "half and half"
	id = "halfandhalf"
	reagent_state = REAGENT_LIQUID
	fluid_r = 142
...
/datum/reagent/fooddrink/swedium
	name = "swedium"
	id = "swedium"
...
/datum/reagent/fooddrink/swedium/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/swedium/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.bioHolder.AddEffect("accent_swedish", timeleft = 180)
	..(M)
...
/datum/reagent/fooddrink/essenceofelvis
...
/datum/reagent/fooddrink/essenceofelvis/reaction_mob(var/mob/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/essenceofelvis/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	M.bioHolder.AddEffect("accent_elvis", timeleft = 180)
	..(M)
...
/datum/reagent/fooddrink/yuck/reaction_mob(var/mob/living/M, var/method=REAC_TOUCH, var/volume_passed)
	src = null
	if(!volume_passed)
		return
	if(!ishuman(M))
...
/datum/reagent/fooddrink/fakecheese
...
/datum/reagent/fooddrink/fakecheese/do_overdose(var/severity, var/mob/M)
	if(!M)
		M = holder.my_atom
...
/datum/reagent/fooddrink/ghostchilijuice
...
/datum/reagent/fooddrink/ghostchilijuice/on_mob_life(var/mob/M)
	if(!M)
		M = holder.my_atom
	//If the user drinks milk, they'll be fine.
	if(M.reagents.has_reagent("milk"))
