...
/obj/item/reagent_containers/move_trigger(var/mob/M, kindof)
	if (..() && reagents)
		reagents.move_trigger(M, kindof)
	return

/obj/item/reagent_containers/proc/ensure_reagent_holder()
	if (src.reagents)
		return
...
/obj/item/reagent_containers/get_desc(dist, mob/user)
	if (dist > 2)
		return
	if (!reagents)
		return
...
/obj/item/reagent_containers/MouseDrop(atom/over_object as obj)
...
/obj/item/reagent_containers/glass/afterattack(obj/target, mob/user , flag)
	if (ismob(target))
		...
		if (istype(T,/mob/living/carbon/human/))
			...
			if (H.hand == 1)
				if (istype(H.l_hand,/obj/item/reagent_containers/glass/))
					G = H.l_hand
			else
				if (istype(H.r_hand,/obj/item/reagent_containers/glass/))
					G = H.r_hand
...
/obj/item/reagent_containers/glass/attackby(obj/item/I as obj, mob/user as mob)
	/*
...
/obj/item/reagent_containers/glass/attack_self(mob/user as mob)
	if (src.splash_all_contents)
...
/obj/item/reagent_containers/glass/proc/smash()
...
/obj/item/reagent_containers/glass/on_spin_emote(var/mob/living/carbon/human/user as mob)
...
/obj/item/reagent_containers/glass/is_open_container()
	return 1
