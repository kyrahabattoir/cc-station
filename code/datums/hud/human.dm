...
/datum/hud/human
	...
	New(M)
		...
		spawn(0)
			...
			back = create_screen("back", "back", src.icon_hud, "back", ui_back, HUD_LAYER+1)
			...
			inventory_bg += create_screen("id", "ID", src.icon_hud, "id", ui_id, HUD_LAYER+1)
			inventory_bg += create_screen("under", "clothing", src.icon_hud, "center", ui_clothing, HUD_LAYER+1)
