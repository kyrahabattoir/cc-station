...
/datum/gauntletDrop
	...
	weapon_cache
		...
		minimum_level = 20
		probability =  20
		supplies = list(/obj/item/chem_grenade/very_incendiary/vr, /obj/item/gun/kinetic/spacker/vr, /obj/item/gun/energy/laser_gun/virtual)
	...
	spackers
		...
		min_percent = 0.25
		max_percent = 0.5
		supplies = list(/obj/item/gun/kinetic/spacker/vr)
