...
/datum/game_mode/restructuring/proc/pick_target(who)
	...
	if (!who)
		...
		target = who
		target_desc = get_target_desc(target)
		boutput(world, "<span style=\"color:red\"><B>HEAD OFFICE: [target_desc] is accused of fornicating with staff of the same sex. Terminate the employee immediately.</b></span>")
