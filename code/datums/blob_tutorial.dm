...
/area/blob_tutorial_zone_2
	name = "Blob Tutorial Zone 2"
	icon_state = "green"

/area/blob_tutorial_zone_3
	name = "Blob Tutorial Zone 3"
	icon_state = "blue"

var/global/list/blob_tutorial_areas = list(/area/blob_tutorial_zone_1, /area/blob_tutorial_zone_2, /area/blob_tutorial_zone_3)
...
/datum/tutorialStep/blob
	...
	spread
		name = "Spreading Out"
		instructions = "While you are small, you are very vulnerable and suffer many penalties. Freshly deployed blobs may spread very quickly, without cost or cooldown to a size of 40 tiles. In order to spread, use the newly gained button in the top left corner of your screen. Spread to the four marked turfs to continue."
	...
	launcher
		...
		var/mob/living/carbon/human/normal/male/assistant/H
		var/obj/blob/target
