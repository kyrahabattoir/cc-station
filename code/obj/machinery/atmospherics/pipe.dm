...
//
	...
	simple
		...
		name = "pipe"
		desc = "An one meter section of regular pipe"
		...
		color_pipe
			cyan_pipe
				...
				desc = "An one meter section of pipe connected to an air hookup reservoir."
			...
			green_pipe
				name = "purge pipe"
				desc = "An one meter section of pipe connected to a waste vent in space."
			...
			yellow_pipe
				...
				desc = "An one meter section of pipe connected to an riot control gas reservoir."
		...
		attackby(var/obj/item/W as obj, var/mob/user as mob)
			if(istype(W, /obj/item/weldingtool) && W:welding)
				...
				if (W:get_fuel() < 1)
					boutput(user, "<span style=\"color:red\">You need more welding fuel to complete this task.</span>")
					return
				W:use_fuel(1)
